      ...
      <table class="w-full text-sm">
        ...
        <tbody>
          ...
          <tr v-if="!branches.length && gameId">
            <td colspan="5" class="px-4 py-8 text-center text-muted-foreground">暂无分支——点「同步分支」从 asset_service 拉取</td>
          </tr>
        </tbody>
      </table>
    </div>
...
import { listBranches, listGames, listNodeAgents, syncBranches, updateBranchCache, type Game, type NodeAgent, type SteamBranch } from '@/api/admin'
