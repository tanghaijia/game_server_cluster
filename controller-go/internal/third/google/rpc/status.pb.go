...
const file_google_rpc_status_proto_rawDesc = "" +
	...
	"\adetails\x18\x03 \x03(\v2\x14.google.protobuf.AnyR\adetailsB\x92\x01\n" +
	"\x0ecom.google.rpcB\vStatusProtoP\x01Z'controller-go/internal/third/google/rpc\xf8\x01\x01\xa2\x02\x03GRX\xaa\x02\n" +
	"Google.Rpc\xca\x02\n" +
